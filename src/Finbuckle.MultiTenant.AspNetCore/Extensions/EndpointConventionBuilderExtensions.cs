...
{
    private static readonly ExcludeFromMultiTenantResolutionAttribute _excludeFromMultiTenantResolutionAttribute = new();

    /// <summary>
    /// Adds the <see cref="IExcludeFromMultiTenantResolutionMetadata"/> to <see cref="EndpointBuilder.Metadata"/> for all endpoints
    /// produced by the <paramref name="builder"/>.
    /// </summary>
    ...
    public static TBuilder ExcludeFromMultiTenantResolution<TBuilder>(this TBuilder builder) where TBuilder : IEndpointConventionBuilder
        => builder.WithMetadata(_excludeFromMultiTenantResolutionAttribute);
